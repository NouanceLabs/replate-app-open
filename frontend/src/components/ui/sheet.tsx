...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[closed=]:duration-200 data-[expanded=]:duration-200 data-[expanded=]:animate-in data-[closed=]:animate-out',
  {
    variants: {
      position: {
